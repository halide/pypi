...
PLATFORMS = (
    {"platform": "x86-64-linux", "runner": "ubuntu-latest", "container": "quay.io/pypa/manylinux_2_28_x86_64", "manylinux_plat": "manylinux_2_28_x86_64"},
    {"platform": "x86-32-linux", "runner": "ubuntu-latest", "docker_image": "quay.io/pypa/manylinux_2_28_i686", "manylinux_plat": "manylinux_2_28_i686", "pin_gcc12": True},
    {"platform": "arm-64-linux", "runner": "ubuntu-24.04-arm", "container": "quay.io/pypa/manylinux_2_28_aarch64", "manylinux_plat": "manylinux_2_28_aarch64"},
    {"platform": "arm-32-linux", "runner": "ubuntu-24.04-arm", "docker_image": "quay.io/pypa/manylinux_2_31_armv7l", "manylinux_plat": "manylinux_2_31_armv7l"},
    ...
    {"platform": "x86-32-windows", "runner": "windows-latest", "msvc_arch": "amd64_x86", "wheel_plat": "win32"},
)
...
def main(arguments: list[str] | None = None) -> None:
    package_paths = [Path(path) for path in (arguments if arguments is not None else sys.argv[1:])]
